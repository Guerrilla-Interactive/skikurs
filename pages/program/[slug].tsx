                  ...
                  <div className="grid justify-start max-w-lg grid-flow-col px-8 py-6 text-white bg-black border border-white rounded-lg border-opacity-30">
                    ...
                    <div className="pr-8 justify-content-center ">
                      ...
                      <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.7998 18.2C1.7998 22.4965 3.50659 26.617 6.54468 29.6551C9.58276 32.6932 13.7033 34.4 17.9998 34.4C22.2963 34.4 26.4168 32.6932 29.4549 29.6551C32.493 26.617 34.1998 22.4965 34.1998 18.2C34.1998 13.9035 32.493 9.78296 29.4549 6.74487C26.4168 3.70678 22.2963 2 17.9998 2C13.7033 2 9.58276 3.70678 6.54468 6.74487C3.50659 9.78296 1.7998 13.9035 1.7998 18.2V18.2Z" stroke="white" stroke-width="3.6" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M17.9998 27.2V20" stroke="white" stroke-width="3.6" stroke-linecap="round" stroke-linejoin="round" />
