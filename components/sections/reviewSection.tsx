...
export default function reviewSection({ title }) {
    return (
        <section className="text-white bg-gray-300 section-full ">
            <div className="relative z-20 grid grid-cols-12 section-full-contained  bg-[#002683] overflow-hidden">
                <div className="mx-auto mt-[150px] max-w-3xl col-start-2 col-end-12 lg:col-end-6 pb-[3rem">
